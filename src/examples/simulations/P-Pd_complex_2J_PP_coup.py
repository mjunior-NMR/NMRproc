...
P_site = Site(isotope="31P", isotropic_chemical_shift=av_diso+diff,
              shielding_symmetric=SymmetricTensor(
        zeta=delta,  # in ppm
        eta=0.82)) #0
P_site_ = Site(isotope="31P", isotropic_chemical_shift=av_diso-diff,
              shielding_symmetric=SymmetricTensor(
        zeta=delta,  # in ppm
        eta=eta)) #1
...
Pd_site = Site(isotope="105Pd", quadrupolar=SymmetricTensor(Cq=Cq, eta=1)) #2
...
coupling_PP = Coupling(site_index=[0, 2],isotropic_j=J_P)
